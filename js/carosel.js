...
//select items. this get replaced with each review
const img = document.getElementById('person-img');
const author = document.getElementById('author');
const job = document.getElementById('job');
const info = document.getElementById('info');

//grab the buttons. not going the query selector all -> foreach route.
const prevBtn = document.querySelector('.prev-btn')
const nextBtn = document.querySelector('.next-btn')
const randomBtn = document.querySelector('.random-btn')

//set starting item - this 'review' displays on pageload from the array
let currentItem = 0;
...
function showPerson(index){
    //pass in first item from array by passing it to a variable

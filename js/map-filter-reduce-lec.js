...
//reassigning the array values.

let newPrice = products.map((product) => product.price += 2)
// creating a new array with only the numbers and adding to them


console.log(products);
console.log(newPrice) // leaves the array alone, copies its (increases prices
//
